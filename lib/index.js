...
function apply(ctx) {
    ...
    // 存储用户上一次提示词的函数
    function saveUserLastPrompt(userId, prompt, orientation, sizeCategory, modelOverride, disableArtistPrompt) {
    ...
    // 修改添加到队列的函数
    function addToQueue(session, prompt, orientation, sizeCategory, modelOverride, disableArtistPrompt) {
